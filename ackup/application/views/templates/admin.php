                ...
                <ul class="nav">
                     ...
                     <?php
                        ...
                        <?php
                         ...
                         echo form_dropdown('city_id', $options_cities, set_value('city_id'),'class="city span2 form-control select2-allow-clear"', 'id="single-append-text"','placeholder="Select City Name"' );

                         echo '</div>';
                         echo '</div>';
                         echo '<input type="hidden" id="select2-name" name="date" value="Select Customer Name"  >';
                      //   $js = array(
                      //                       'class' => 'city span2 form-control select2-allow-clear',
                      //                       'id' => 'select2-name',
                      ...
                      //   echo '<label for="city_id" for="inputError" class="control-label">City Name</label>';
                      //   echo '<div  class="controls">';
                      //     echo form_dropdown('city_id', $options_cities, set_value('city_id'), $js );
    ...
    function showRoute(orig,destin,rendererOptions) {
        ...
        directionsService.route(request, function(response, status) {
            if (status == google.maps.DirectionsStatus.OK) {              
                obj.addMarker(new MarkerOptions()
        ...
        directionsService.route(request, function(response, status) {
            if (status == google.maps.DirectionsStatus.OK) {
                ...
                obj.addMarker(new MarkerOptions()
                            ...
                            .icon(BitmapDescriptorFactory.fromResource(R.drawable.arrow)));
                obj.setDirections(response);
                //makeMarker( request.start_location, icons.start, "title" );
                obj.setMap(map);
            }
        });
    ...
    function loadwaypointmap(id){
        ...
        if(imageArray.length !== 0) {
            ...
            $.each( imageArray, function( key, value ) {
                $('<div class="carousel-feature"><a><img style"height:180px;width:180px;" class="carousel-image" alt="Image Caption" src="'+value+'"></a></div>').appendTo('#carousel');
            ...
            if ($(this).is(':checked')) {
                ...
                // alert(color);
                // alert(wp);
                // var rander = new google.maps.Marker({
                //         position: latLng,
                //         sName: "Marker Name",
                //         map: map,
                //         icon: {
